...
const emptyProfile: Profile = {
  id: null, userId: 'user-1', version: null, nationalId: null, birthDate: null, phone: null,
  addressLine: null, city: null, postalCode: null, countryCode: null, universityId: null,
  universityName: null, departmentId: null, departmentName: null, otherUniversity: null,
  otherDepartment: null, educationLevel: null, studyYear: null, gpa: null, updatedAt: null,
}
...
describe('ProfilePage', () => {
  it('loads the current users isolated profile and reference data', async () => {
    ...
    vi.mocked(profileApi.universities).mockResolvedValue([{ id: 'university-1', name: 'Test Üniversitesi', countryCode: 'TR' }])
    render(<ProfilePage />)
